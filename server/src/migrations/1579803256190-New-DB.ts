...
export class NewDB1579803256190 implements MigrationInterface {
    name = 'NewDB1579803256190'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "Cliente" ("id" int NOT NULL IDENTITY(1,1), "rut" varchar(12) NOT NULL, "nombres" varchar(100) NOT NULL, "apellidoP" varchar(100) NOT NULL, "apellidoM" varchar(100) NOT NULL, "fechaNac" datetime NOT NULL, "telefono" varchar(20), "email" varchar(100), CONSTRAINT "PK_d6b00ec12b8a60095cc4389d35d" PRIMARY KEY ("id"))`, undefined);
