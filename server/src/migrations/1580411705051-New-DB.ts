...
export class NewDB1580411705051 implements MigrationInterface {
    name = 'NewDB1580411705051'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "Venta" ("id" int NOT NULL IDENTITY(1,1), "correlat" int NOT NULL, "fecha" datetime NOT NULL CONSTRAINT "DF_a16ee828164f90cc9b6bd6467f2" DEFAULT CURRENT_TIMESTAMP, "isServed" bit NOT NULL CONSTRAINT "DF_d380c7becd79a388ca9a59f0d52" DEFAULT 0, "tipoAteId" int, "clienteId" int, "totemId" int, CONSTRAINT "PK_2e7a31f0c6a99fe691dabfb2fa2" PRIMARY KEY ("id"))`, undefined);
